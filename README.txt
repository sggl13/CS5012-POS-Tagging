...
Once the program is running, please follow the instructions provided by the “MAIN MENU” in the command line to run the two algorithms implemented and to exit the program.
